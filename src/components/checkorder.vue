                                    ...
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link class="btn-pay" v-if="orderinfo.status==1" :to="'/orderInfo/'+orderinfo.id">去付款</router-link>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" class="ftable">
                                            <tbody>
                                                ...
                                                <tr v-for="(item, index) in goodslist" :key="item.id">
                                                    ...
                                                    <td align="left">
                                                        <router-link :to="/goodsdetail/+item.goods_id">{{item.goods_title}}</router-link>
                                                    </td>
                                                    <td align="center">
